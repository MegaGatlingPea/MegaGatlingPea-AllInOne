...
from coati.optimize.rules.sascorer import calculateScore

current_script_path = os.path.abspath(__file__)
directory_of_script = os.path.dirname(current_script_path)

smarts = pd.read_csv(os.path.join(directory_of_script,'rules', "sure_chembl_alerts.txt"), header=None, sep='\t')[1].tolist()
